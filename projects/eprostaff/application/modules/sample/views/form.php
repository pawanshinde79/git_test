<div class="content-wrapper">
         ...
         <h1>
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-gears"></i> Configuration</a></li><i class="fa fa-arrow-right" style="font-size:12px;"></i>
            <li><a href="<?php echo base_url(); ?>module_setting/">Module Setting</a></li>
            <i class="fa fa-arrow-right" style="font-size:12px;"></i>
            <li class="active">Module Setting Manage</li>
          </ol>        
        </section>
